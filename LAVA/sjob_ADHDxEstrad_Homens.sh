#!/bin/bash
#SBATCH --job-name=ADHDxESTRAD_H    # Job name


#SBATCH --ntasks=1                    # Run on a single CPU
#SBATCH --mem=64gb                     # Job memory request
#SBATCH --time=192:00:00               # Time limit hrs:min:sec
#SBATCH --output=/home/physiogenlab/LAVA/outputs/LAVA_ADHDxESTRAD_H_%j.log   # Standard output and error log
pwd; hostname; date
...
"ADHD;ESTRAD_H" \
"/home/kleber/15.07.2024-ADHDxESTRAD_H"
