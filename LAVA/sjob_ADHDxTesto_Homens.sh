#!/bin/bash
#SBATCH --job-name=ADHDxTESTO_H    # Job name


#SBATCH --ntasks=1                    # Run on a single CPU
#SBATCH --mem=64gb                     # Job memory request
#SBATCH --time=192:00:00               # Time limit hrs:min:sec
#SBATCH --output=/home/physiogenlab/LAVA/outputs/LAVA_ADHDxTESTO_H_%j.log   # Standard output and error log
pwd; hostname; date
...
"ADHD;TESTO_H" \
"/home/kleber/15.07.2024-ADHDxTESTO_H"
